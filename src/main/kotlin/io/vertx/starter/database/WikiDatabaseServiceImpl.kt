...
class WikiDatabaseServiceImpl(private val dbClient: JDBCClient, private val sqlQueries: HashMap<SqlQuery, String>, readyHandler: Handler<AsyncResult<WikiDatabaseService>>) : WikiDatabaseService {

  companion object {
    @JvmStatic private val LOGGER = LoggerFactory.getLogger(WikiDatabaseServiceImpl::class.java)
  }
